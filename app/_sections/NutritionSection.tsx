...
function NutritionSection() {
    ...
    useGSAP(()=>{
        ...
        const paragraphSplit = SplitText.create('.nutrition-section p',{ type: "words, lines",
  ...
  return (
    <section className="nutrition-section">
        <Image src="/images/slider-dip.png" alt="separator" width={4000} height={200} className="w-full object-cover"/>
        <Image src="/images/big-img.png" alt="big-img" width={4000} height={4000} className="big-img"/>
